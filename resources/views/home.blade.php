        ...
        <div class="col-8 text-center">
            <div class="card bg-dark" id="homeCard">
                <div class="card-body">
                    ...
                    <button id="homeButton" class="btn btn-outline-info" type="submit" onclick="window.location=' {{ url("/income") }} '"">Incomes</button>
                    <h4 id="homeSlogen" class="card-title text-light">Check out the spendings here!</h4>
                    <button id="homeButton" class="btn btn-outline-info" type="submit" onclick="window.location=' {{ url("/spending") }} '"">Spendings</button>
