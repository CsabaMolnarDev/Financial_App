            ...
            <div class="col-6">
                <div class="card bg-dark text-light" style="border: 1px solid lightgray">
                    <div class="card-body">
                        ...
                        <br>
                        <p>Avarage spending in your country: {{ $spendingsAverage }} {{ $currencySymbol }}</p>
            ...
            <div class="specialcard h-130">
                <div class="specialcard-body">
                    ...
                    @foreach ($familyMembers as $member)
                        ...
                        <p class="specialcard-text">Total Spending:<br>{{ $totalSpending }} {{ $memberCurrencySymbol }}
                        </p>
                        <hr>
                    @endforeach
                </div>
                    ...
                    <div class="card-body">
                        <div class="card-title">
                            ...
                            @if (isset($memberSpending))
                                <p>Member Spending for this month: {{ $memberSpending }} {{ $familyMemberCurrencySymbol }}
                                </p>
                            @endif
